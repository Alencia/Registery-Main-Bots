const nameData = require("../../KayitData/names")
...
module.exports = {
  ...
  run: async (client, message, args, embed, prefix) => { 
    ...
    {
      message.react(red)
    message.lineReply(`Yetkin bulunmamakta. [HATA!]`).then(x=> x.delete({timeout: 5000})) 
    return }
    ...
    embed.setTitle(`${member.user.username} üyesinin isim bilgileri; [BAŞARILI]`);
